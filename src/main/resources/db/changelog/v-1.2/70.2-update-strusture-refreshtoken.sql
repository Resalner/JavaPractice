...
ALTER TABLE user_tokens ADD COLUMN access_token_expiration TIMESTAMP WITH TIME ZONE NOT NULL;
ALTER TABLE user_tokens ADD COLUMN refresh_token VARCHAR(255) UNIQUE NOT NULL;
ALTER TABLE user_tokens ADD COLUMN refresh_token_expiration TIMESTAMP WITH TIME ZONE NOT NULL;